...
type User struct {
	...
	CreatedAt     time.Time `gorm:"default:now()"`                     // Fecha de creación
	UpdatedAt     time.Time `gorm:"default:now()"`                     // Fecha de última actualización
...
type Activity struct {
	...
	CreatedAt     time.Time `gorm:"default:now()"`              // Fecha de la actividad
}
